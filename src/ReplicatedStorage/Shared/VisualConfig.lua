...
return {
	...
	Particles = {Poison = "rbxasset://textures/particles/smoke_main.dds", Gravity = "rbxasset://textures/particles/smoke_main.dds", Prismatic = "rbxasset://textures/particles/sparkles_main.dds"},
	Elements = {
