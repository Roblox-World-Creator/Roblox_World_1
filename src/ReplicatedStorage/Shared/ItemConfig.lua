local config = {
	...
	Items = {
		...
		CelestialLightblade = {DisplayName = "Aurelia, Light of Hours", Category = "Weapon", WeaponType = "Greatsword", Element = "Fire", Rarity = "Mythic", MaximumStack = 1, BuyPrice = 18000, RequiredLevel = 30, EquipSlot = "Weapon", ModelProfile = "CelestialLightbladeModel01", Passive = "Solar Timeburst", AbilityId = "Meteor", Description = "A celestial blade that stores daylight between strikes.", Stats = {Attack = 62, Power = 38, CriticalDamage = 0.35}, WeaponColor = Color3.fromRGB(255, 235, 130), WeaponSize = Vector3.new(0.55, 6.2, 1)},
		SolarChaingun = {DisplayName = "Helios Rotary", Category = "Weapon", WeaponType = "Chaingun", WeaponKind = "Rifle", Element = "Fire", Rarity = "Mythic", MaximumStack = 1, BuyPrice = 22000, RequiredLevel = 35, EquipSlot = "SecondaryWeapon", ModelProfile = "SolarChaingunModel01", Passive = "Overheat Barrage", AbilityId = "Meteor", Description = "A six-barrel relic tuned to solar ammunition.", Stats = {Attack = 68, Power = 25, CriticalChance = 0.08}, WeaponColor = Color3.fromRGB(255, 170, 50), WeaponSize = Vector3.new(0.75, 5.5, 1.2)},
		EmberRepeater = {DisplayName = "Cinderline Repeater", Category = "Weapon", WeaponType = "SMG", WeaponKind = "Gun", Element = "Fire", Rarity = "Epic", MaximumStack = 1, BuyPrice = 6800, RequiredLevel = 15, EquipSlot = "SecondaryWeapon", ModelProfile = "EmberRepeaterModel01", Passive = "Rapid Burn", AbilityId = "FlameWave", Description = "A vintage repeater rebuilt around an ember chamber.", Stats = {Attack = 35, CriticalChance = 0.07, Speed = 2}, WeaponColor = Color3.fromRGB(230, 100, 55), WeaponSize = Vector3.new(0.55, 4.5, 0.9)},
		FrostPistol = {DisplayName = "Whiteout Sidearm", Category = "Weapon", WeaponType = "Pistol", WeaponKind = "Gun", Element = "Ice", Rarity = "Rare", MaximumStack = 1, BuyPrice = 2900, RequiredLevel = 9, EquipSlot = "SecondaryWeapon", ModelProfile = "FrostPistolModel01", Passive = "Chill Shot", AbilityId = "IceShard", Description = "A compact pistol that flash-freezes impact points.", Stats = {Attack = 24, CriticalChance = 0.08, Power = 5}, WeaponColor = Color3.fromRGB(125, 220, 255), WeaponSize = Vector3.new(0.45, 2.2, 0.8)},
		TempestLaser = {DisplayName = "Tempest Hyperbeam", Category = "Weapon", WeaponType = "Laser", WeaponKind = "Rifle", Element = "Lightning", Rarity = "Legendary", MaximumStack = 1, BuyPrice = 11200, RequiredLevel = 24, EquipSlot = "SecondaryWeapon", ModelProfile = "TempestLaserModel01", Passive = "Instant Arc", AbilityId = "LightningBolt", Description = "A hyper-laser that ionizes its entire firing lane.", Stats = {Attack = 51, CriticalChance = 0.13, Power = 18}, WeaponColor = Color3.fromRGB(255, 235, 95), WeaponSize = Vector3.new(0.4, 4.8, 0.75)},
		StonehandCannon = {DisplayName = "Stonehand Verdict", Category = "Weapon", WeaponType = "Hand Cannon", WeaponKind = "Gun", Element = "Earth", Rarity = "Epic", MaximumStack = 1, BuyPrice = 5900, RequiredLevel = 14, EquipSlot = "SecondaryWeapon", ModelProfile = "StonehandCannonModel01", Passive = "Seismic Round", AbilityId = "GroundSlam", Description = "A heavy sidearm whose rounds land like falling stone.", Stats = {Attack = 42, Defense = 6, CriticalDamage = 0.2}, WeaponColor = Color3.fromRGB(150, 120, 80), WeaponSize = Vector3.new(0.55, 2.6, 0.9)},
		ThunderKatana = {DisplayName = "Thunder Katana", Category = "Weapon", WeaponType = "Katana", Element = "Lightning", Rarity = "Epic", MaximumStack = 1, BuyPrice = 5200, RequiredLevel = 12, EquipSlot = "Weapon", ModelProfile = "ThunderKatanaModel01", Passive = "Chain Spark", AbilityId = "LightningBolt", Evolution = "Stormblade", Description = "A fast storm-forged katana that conducts chain energy.", Stats = {Attack = 31, CriticalChance = 0.09, Speed = 3, Power = 12}, WeaponColor = Color3.fromRGB(255, 225, 75), WeaponSize = Vector3.new(0.22, 5.2, 0.48)},
		InfernoSword = {DisplayName = "Inferno Sword", Category = "Weapon", WeaponType = "Greatsword", Element = "Fire", Rarity = "Epic", MaximumStack = 1, BuyPrice = 5600, RequiredLevel = 14, EquipSlot = "Weapon", ModelProfile = "InfernoSwordModel01", Passive = "Burn", AbilityId = "FlameWave", Evolution = "SolarEdge", Description = "An ember-cored greatsword that leaves burning impacts.", Stats = {Attack = 38, CriticalDamage = 0.22, Power = 14}, WeaponColor = Color3.fromRGB(255, 80, 35), WeaponSize = Vector3.new(0.62, 6, 1.05)},
	...
	LootTables = {
		Basic = {
			{ItemId = "HealthPotion", Weight = 16}, {ItemId = "EvolutionShard", Weight = 8},
			{ItemId = "IronBlade", Weight = 2}, {ItemId = "DawnsteelSword", Weight = 1},
		},
		Fast = {
			{ItemId = "ManaPotion", Weight = 18}, {ItemId = "EvolutionShard", Weight = 10},
			{ItemId = "SkyglassKatana", Weight = 1}, {ItemId = "FrostPistol", Weight = 1},
		},
		Tank = {
