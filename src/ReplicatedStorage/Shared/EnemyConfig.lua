...
return {
	...
	ShinyChicken = enemy("Shiny Ascendant Chicken", 450, 18, 16, 120, 60, Color3.fromRGB(255, 245, 155), nil, 0.2, {Ability = "Golden Peck", AttackStyle = "Lunge", StatusEffect = "Shock", LootTier = "Elite", Element = "Prismatic", RequiredLevel = 1, VisualKind = "Chicken"}),
	LavaTitan = enemy("Lava Titan", 6200, 115, 7, 1800, 900, Color3.fromRGB(255, 70, 25), "LavaGolemModel01", 0.8, {Ability = "Caldera Collapse", AttackStyle = "Area", AbilityRadius = 22, StatusEffect = "Burn", LootTier = "Boss", Element = "Fire", RequiredLevel = 10}),
	FrostGiant = enemy("Frost Giant", 10500, 175, 7, 2800, 1400, Color3.fromRGB(125, 225, 255), "IronGolemModel01", 0.82, {Ability = "Absolute Avalanche", AttackStyle = "Area", AbilityRadius = 24, StatusEffect = "Slow", LootTier = "Boss", Element = "Ice", RequiredLevel = 30}),
	StormColossus = enemy("Storm Colossus", 16500, 250, 9, 4300, 2200, Color3.fromRGB(255, 230, 75), "RiftDragonModel01", 0.84, {Ability = "Heaven Splitter", AttackStyle = "Ranged", AttackRange = 42, StatusEffect = "Shock", LootTier = "Boss", Element = "Lightning", RequiredLevel = 50, Flying = true, HoverHeight = 7}),
	MountainGuardian = enemy("Mountain Guardian", 26000, 360, 6, 6500, 3400, Color3.fromRGB(120, 185, 85), "MountainGuardianModel01", 0.9, {Ability = "Continental Break", AttackStyle = "Area", AbilityRadius = 28, StatusEffect = "Crush", LootTier = "Boss", Element = "Earth", RequiredLevel = 70}),
	PrismaticOverlord = enemy("The Prismatic Ascendant", 65000, 525, 10, 15000, 10000, Color3.fromRGB(255, 100, 220), "RiftDragonModel01", 0.92, {Ability = "Sevenfold Extinction", AttackStyle = "Area", AbilityRadius = 34, StatusEffect = "Poison", LootTier = "Boss", Element = "Prismatic", RequiredLevel = 100, Flying = true, HoverHeight = 9}),
}
