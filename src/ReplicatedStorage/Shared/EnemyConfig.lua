...
return {
	...
	AshwingDrake = enemy("Ashwing Wyrmling", 320, 29, 12, 48, 24, Color3.fromRGB(255, 115, 55), "AshwingDrakeModel01", 0.28, {Ability = "Scorch Breath", AttackStyle = "Ranged", AttackRange = 30, StatusEffect = "Burn", LootTier = "Elite"}),
	RiftDragon = enemy("Parallax Sky-Tyrant", 920, 46, 11, 110, 58, Color3.fromRGB(165, 80, 255), "RiftDragonModel01", 0.58, {Ability = "Void Breath", AttackStyle = "Ranged", AttackRange = 38, StatusEffect = "Void", LootTier = "Elite"}),
