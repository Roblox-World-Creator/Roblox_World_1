...
startSystem("Combat", function()
	CombatService.Start(ProgressionConfig, PlayerProgression, DamageService, InventoryService, MasteryService, QuestService)
end)
...
startSystem("Admin", function()
	AdminService.Start(AdminConfig, WaveDefense, InventoryService, ItemConfig)
end)
startSystem("Store", function()
	StoreService.Start(ItemConfig, InventoryService)
end)
startSystem("Movement", function()
	MovementService.Start(ResourceConfig)
end)
